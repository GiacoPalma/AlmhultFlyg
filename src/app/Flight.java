...
public class Flight {
	...
	public boolean checkPrice() {
		if (this.price == null) {
			errorMessages.add("Du måste fylla i ett pris");
			return false;
		} else {
			return true;
		}
	...
	public boolean checkDeparture() {
		if (this.depature_airport_id == null || this.depature_airport_id <= 0) {
			errorMessages.add("Du måste välja avreseort");
			return false;
		} else {
			return true;
		}
	...
	public boolean checkDestination() {
		if (this.destination_airport_id == null
			...
			errorMessages.add("Du måste välja destination");
			return false;
		} else {
			return true;
		}
	...
	public boolean checkDepartureDate() {
		if (this.depature_date == null || this.depature_date == "") {
			errorMessages.add("Du måste välja ett datum för avresa");
			return false;
		} else {
			return true;
		}
	...
	public boolean checkDestinationDate() {
		if (this.destination_date == null) {
			errorMessages.add("Du måste välja ett datum för destination");
			return false;
		} else {
			return true;
		}
